...
//  MapBox Navigation Test
//
//  Created by Jason Ho on 1/26/18.
...
class ViewController: UIViewController, MGLMapViewDelegate {
    ...
    func drawRoute(route: Route) {
        ...
        if let source = mapView.style?.source(withIdentifier: "route-source") as? MGLShapeSource {
            ...
            lineStyle.lineColor = MGLStyleValue(rawValue:  _ColorLiteralType(red: 0.1897518039, green: 0.3010634184, blue: 0.7994888425, alpha: 1))
